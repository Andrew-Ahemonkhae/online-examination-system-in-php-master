...
<link  rel="stylesheet" href="css/bootstrap.min.css"/>
 ...
 <link rel="stylesheet" href="css/timer_file.css">
...
<div class="col-md-4 col-md-offset-2">
 ...
 // THIS ONLY WORKS IF TESTED WITH CPANEL CREDENTIALS
...
<!-- This is the javascript function that displays the set time -->

<!-- <script>
// Set the date we're counting down to
var countDownDate = new getTime(00:10:00);
...
// Timer element starts
echo ' <div id="countdown" class="countdown-content">
...
//   $mail->isSMTP();            
//   //Set SMTP host name                          
//   $mail->Host = "onlineexamsystem.ahemonkhaeandrew.com.ng";
//   //Set this to true if SMTP host requires authentication to send email
//   $mail->SMTPAuth = false;                          
//   //Provide username and password     
//   $mail->Username = "andrew@onlineexamsystem.ahemonkhaeandrew.com.ng";                 
...
//   $mail->From = "andrew@onlineexamsystem.ahemonkhaeandrew.com.ng";
...
//   $mail->Subject = "YOUR RESULTS FROM ONLINE EXAMINATION SYSTEM.";
...
//   $mail->Body = file_get_contents("resultmsg.php");
...
// put the email code into here to utilise the already retrieved values
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/waalpapaer.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Ahemonkhae Andrew</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">08149135478</h4>
		<h4 style="font-family:'typo' ">ahemonkhaeandrew@gmail.com</h4>
		<h4 style="font-family:'typo' ">New Horizons Institute, Ikorodu, Lagos.</h4></div></div>
		</p>
      </div> -->
